...
def lambda_handler(event, context):
  try:
    ...
    # if we get here, the job still open. So we should have results
    ...
    #     model="gpt-4",
    # )
    # jd_json = chat_completion.choices[0].message.content
